...
public class GuiKeybindsList extends GuiListExtended {
	...
	private GuiListExtended.IGuiListEntry selectedEntry;
	...
	public GuiKeybindsList(GuiScreen parentScreen) {
		...
		this.keyEntries = new GuiListExtended.IGuiListEntry[Wrapper
				.getModuleManager().getModuleList().size()];
		...
		for (Entry<String, Module> moduleEntry : sortedModules.entrySet()) {
			this.keyEntries[index] = new GuiListEntryModuleKey(
					moduleEntry.getValue(), parentScreen);
